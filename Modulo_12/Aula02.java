...
public class Aula02 {
    ...
    public static void main(String[] args) {
        //exemploBubbleSortFixo();
        exemploBubbleSortDinamico();
        //exemplosArray();
    }

    public static void exemploBubbleSortFixo(){
        System.out.println("**** exemploBubbleSortFixo ****");
        int[] vet = {8, 9, 3, 5, 1};
        int aux = 0;
        int i = 0;
    ...
    public static void exemploBubbleSortDinamico(){
        System.out.println("***** exemploBubbleSortDinamico *****");
    ...
    public static void exemplosArray(){
        System.out.println("***** exemplosArray *****");
        declaracaoArray();
        tamanhoArray();
        percorrendoArray1();
        percorrendoArray2();
